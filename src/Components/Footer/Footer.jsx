...
const Footer = () => {
  return (
    <>
      <footer className="bg-neutral-primary-soft bg-[#1e2939] ">
        <div className="w-full p-4 py-6 mx-auto max-w-300 lg:py-8">
            ...
            <div className="mb-6 md:mb-0">
              <a href="https://flowbite.com/" className="flex items-center">
                <img
                  ...
                  alt="FlowBite Logo"
                />
                <span className="self-center text-2xl font-semibold text-heading whitespace-nowrap">
                  Flowbite
                </span>
              </a>
            </div>
